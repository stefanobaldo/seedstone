...
use executor::{Memory, ShardState, run_executor};
...
mod tests {
    ...
    use super::*;
    use crate::dict::{Entry, WalkOrder};
    use crate::log::Record;
    use crate::memory::EvictionMode;
    use crate::shard::apply::{apply, scan_step};
    use crate::shard::executor::evict_until_fits;
    use std::sync::Mutex;
